...
<section class="profile-user">
	...
	<div class="settings">
		<button class="btn-setting dropdown-toggle parent" href="#" role="button" data-bs-toggle="dropdown"
			aria-expanded="false">
			Settings
		</button>
		<ul class="dropdown-menu menu-setting">
			...
			<li>
				<a class="dropdown-item" href="<?= base_url('auth/logout') ?>" type="button" data-bs-toggle="modal"
...
<section class="content-galery container-fluid" id="aboutus">
	...
	<div class="row row-video">
		...
		<div class="frame-video col-sm-4 onmodal" data-bs-toggle="modal" data-bs-target="#videoModal"
			data-delcontent="<?= base_url('profile/del_video/') ?><?= $video->id_content ?>"
			data-idcontent="<?= base_url('profile/edit_video/') ?><?= $video->id_content ?>"
			data-avatar="<?= base_url('assets/img/profile/') . $video->image ?>" data-username="<?= $video->username ?>"
			data-date="<?= $video->create_at ?>" data-content="<?= $video->content_link ?>"
			data-judul="<?= $video->judul ?>" data-desc="<?= $video->desc_content ?>">
							...
							<div class="row user">
								...
								<div class="col-md-auto btn-action">
									<ul class="nav-item kategori dropdown dropdown-menu-end  no-arrow">
										<a class="btn dropdown-toggle parent" href="#" role="button"
										...
										<ul class="dropdown-menu">
											<li>
												<a class="dropdown-item" href="" data-bs-toggle="modal"
													data-bs-target="#delVideo">Hapus Postingan</a>
											</li>
											<li>
