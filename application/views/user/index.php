...
<div class="container-fluid main-content">
			...
			<div class="row people-content g-0">
					...
					<div class="row user">
						<div class="col-md-auto img-profile">
							<a class="nav-link user-img" href="#" role="button" aria-expanded="false">
								<img id="avatar" class="img-profile rounded-circle"
									src="<?= base_url('assets/img/profile/') . $video->image ?>">
							</a>
						</div>
						<div class="col-md-auto name-profile">
							<a href="">
								<div class="nama">
									<h4 class="mr-2 d-lg-inline name"><?= $video->username ?></h4>
								</div>
				...
				<div class="col-md-7 content-parent">
					<div class="container video">
						<video class="onmodal" data-bs-toggle="modal" data-bs-target="#videoModal"
							data-avatar="<?= base_url('assets/img/profile/') . $video->image ?>"
							data-username="<?= $video->username ?>" data-date="<?= $video->create_at ?>"
							data-content="<?= $video->content_link ?>" data-judul="<?= $video->judul ?>"
							data-desc="<?= $video->desc_content ?>">
				...
				<div class="col-md-5 content-coment">
					<h5 class="card-title onmodal" class="onmodal" data-bs-toggle="modal" data-bs-target="#videoModal"
						data-avatar="<?= base_url('assets/img/profile/') . $video->image ?>"
						data-username=" <?= $video->username ?>" data-date="<?= $video->create_at ?>"
						data-content="<?= $video->content_link ?>" data-judul="<?= $video->judul ?>"
						data-desc="<?= $video->desc_content ?>"><?= $video->judul ?></h5>
					<p class="desc"><?= $video->desc_content ?></p>
					<!-- Coment user -->
					<div class="card-body">
								...
								<div class="col-md-auto img-profile">
									<a class="nav-link user-img" href="#" role="button" aria-expanded="false">
										<img class="img-profile rounded-circle"
											src="<?= base_url('assets/img/profile/') . $comment->image ?>">
									</a>
								</div>
					...
					<div class=" container input-comment">
						<form class="d-flex comment" role="" action="<?= base_url('user/comment') ?>" method="POST">
							...
							<input class="form-control" type="text" name="komentar" id="komentar"
								placeholder="Masukan Comment" aria-label="Comment">
					...
					<div class="modal-content modal-content-video">
						<div class="row people-content g-0">
							...
							<div class="col-md-5 content-coment">
								...
								<div class="container input-comment">
									<form class="d-flex comment" role="" action="<?= base_url('user/comment') ?>"
										method="POST">]
										<input type="hidden" name="id_user" id="" value="<?= $user['id_user'] ?>">
	...
	<!-- data coment -->
	<!-- <?php foreach ($comments as $comment) : ?> -->
	<div class="container box-coment" hidden data-idcontent="<?= $comment->id_content ?>"
		data-usercoment="<?= $comment->id_user ?>" data-komen="<?= $comment->komentar ?>">
		<div class="row user-coment">
			<div class="col-md-auto img-profile">
				<a class="nav-link user-img" href="#" role="button" aria-expanded="false">
					<img class="img-profile rounded-circle"
			...
			<div class="col-md-9 name-profile">
				<a href="">
					<div class="nama">
						<h4 class="mr-2 d-lg-inline name"><?= $comment->username ?></h4>
					</div>
					<p class="mr-2 d-lg-inline time"><?= $comment->date ?></p>
				</a>
			</div>
